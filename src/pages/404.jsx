	...
	return (
		<div className='grid min-h-fit h-[90dvh] place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8'>
			<div className='text-center'>
				<p className='text-4xl font-semibold text-sunflower'>Sorry, there&lsquo;s nothing here</p>
				...
				<div className='flex items-center justify-center mt-24 gap-x-6'>
					<Link
						href='/'
						className='flex items-center justify-center px-6 py-2 transition-colors bg-transparent border-2 rounded-lg shadow-lg hover:border-cream border-navy hover:bg-sunflower hover:text-white hover:scale-110'>
						<span>
