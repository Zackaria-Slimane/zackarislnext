...
export function ContactCards() {
	return (
		<div className='flex items-center justify-between gap-6 pt-8'>
			<div>
				<Link
					href='https://drive.google.com/file/d/1kmzoXHXK6SZdMQMKQlHqKKfk3IdoRl4B/view?usp=sharing'
					target='_blank'
			...
			<div>
				<Link href={siteData.socials.twitter} target='_blank' rel='noreferrer noopener'>
